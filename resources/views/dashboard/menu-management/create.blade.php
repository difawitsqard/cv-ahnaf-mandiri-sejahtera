...
@section('content')
    <x-page-title title="Menu" subtitle="Tambah Menu" />

    <form action="{{ roleBasedRoute('menu.store', ['outlet' => $outlet->slug]) }}" method="POST"
                        ...
                        <div class="text-white">
                            <ul class="mb-1">
                                ...
                                <li>Menu yang <b>tidak terkait</b> dengan <strong>Item Etalase</strong> Memiliki
                                    Ketersediaan
                                    Tidak Terbatas.</li>
                                <li><b>Item Etalase</b> yang terkait akan <b>otomatis mengurangi stok</b> setiap ada pembelian.</li>
                            </ul>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="row">
                                    ...
                                    @foreach (range(1, 4) as $index)
                                        <div class="col-6 mb-2">
                                            <label class="picture-input-costum" for="menu_pict_{{ $index }}"
                                            ...
                                            <input type="file" name="menu_pict_{{ $index }}"
                                                class="picture__input" id="menu_pict_{{ $index }}">
                                        </div>
                                    @endforeach
